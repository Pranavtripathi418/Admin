...
function onsubmit(e) {
    ...
    axios.post('https://crudcrud.com/api/505b406d7272471ba5d4ea8fd54fb5e3/products', myoj)
...
function deletefn(userid) {
    ...
    axios.delete(`https://crudcrud.com/api/505b406d7272471ba5d4ea8fd54fb5e3/products/${userid}`)
        .then(() => {
...
window.addEventListener("DOMContentLoaded", () => {
    ...
    axios.get("https://crudcrud.com/api/505b406d7272471ba5d4ea8fd54fb5e3/products")
        .then((res) => {
